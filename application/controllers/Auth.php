...
class Auth extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->form_validation->set_error_delimiters($this->config->item('error_start_delimiter', 'ion_auth'), $this->config->item
		('error_end_delimiter', 'ion_auth'));
	...
	*/
	...
	public function edit_user($id)
	{
		...
		$this->form_validation->set_rules('alamat', $this->lang->line('edit_user_validation_alamat_label'), 'trim');
